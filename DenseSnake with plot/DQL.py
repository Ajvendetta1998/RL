...
class DQL:
    def __init__(self, model, actions, discount_factor=0.95, exploration_rate=0.9, memory_size=100000, batch_size=20,base_decay_rate = 0.99995, decay_rate=0.9985, base_exploration_rate = 0.1,validation_batch_size = 100):
        #NN
    ...
    def evaluate(self):
        ...
        self.mean_loss = (self.mean_loss*self.n + loss[0])/(self.n+1)
        print("Exploration rate " , self.exploration_rate, "mean loss ", self.mean_loss)